    ...
    <section className="project" ref={projectRef}>
      ...
      <article>
        ...
        <div className="project_text">
          ...
          <div className="btn_group">
            <a
              href="https://kimnarr.github.io/cloneSite/"
              target="_blank"
            ...
            <a
              href="https://github.com/kimNarr/cloneSite"
              target="_blank"
      ...
      <article>
        ...
        <div className="project_text">
          ...
          <div className="btn_group">
            <a
              href="https://visionary-panda-45ba8e.netlify.app/"
              target="_blank"
              className="btn btn_red"
            >
              view
            ...
            <a
              href="https://github.com/kimNarr/weather_app"
              target="_blank"
              className="btn btn_normal"
            >
              github
